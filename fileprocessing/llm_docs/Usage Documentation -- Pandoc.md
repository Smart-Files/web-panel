...
#### [](#extension-backtick_code_blocks)Extension: `backtick_code_blocks` ±

Same as `fenced_code_blocks`, but uses backticks (`` ` ``) instead of tildes (`~`).

#### [](#extension-fenced_code_attributes)Extension: `fenced_code_attributes` ±
...
#### [](#extension-fancy_lists)Extension: `fancy_lists` ±
...
#### [](#extension-startnum)Extension: `startnum` ±
...
#### [](#extension-task_lists)Extension: `task_lists` ±
...
#### [](#extension-table_captions)Extension: `table_captions` ±
...
#### [](#extension-simple_tables)Extension: `simple_tables` ±
...
#### [](#extension-multiline_tables)Extension: `multiline_tables` ±
...
#### [](#extension-grid_tables)Extension: `grid_tables` ±
...
#### [](#extension-intraword_underscores)Extension: `intraword_underscores` ±
...
#### [](#extension-inline_code_attributes)Extension: `inline_code_attributes` ±
...
#### [](#extension-raw_attribute)Extension: `raw_attribute` ±
...
An inline link consists of the link text in square brackets, followed by the URL in parentheses. (Optionally, the URL can be followed by a link title, in quotes.)
    ...
    This is an inline link, and here's [one with
...
#### [](#extension-shortcut_reference_links)Extension: `shortcut_reference_links` ±
...
#### [](#extension-implicit_figures)Extension: `implicit_figures` ±
...
Attributes can be set on links and images:
    ...
    An inline !image{#id .class width=30 height=20px}
...
#### [](#extension-fenced_divs)Extension: `fenced_divs` ±
...
#### [](#extension-bracketed_spans)Extension: `bracketed_spans` ±
...
#### [](#extension-inline_notes)Extension: `inline_notes` ±
...
#### [](#extension-rebase_relative_paths)Extension: `rebase_relative_paths` ±
...
The use of this extension is best understood by example. Suppose you have a subdirectory for each chapter of a book, `chap1`, `chap2`, `chap3`. Each contains a file `text.md` and a number of images used in the chapter. You would like to have `!image` in `chap1/text.md` refer to `chap1/spider.jpg` and `!image` in `chap2/text.md` refer to `chap2/spider.jpg`. To do this, use

    pandoc chap*/*.md -f markdown+rebase_relative_paths

Without this extension, you would have to use `!image` in `chap1/text.md` and `!image` in `chap2/text.md`. Links with relative paths will be rewritten in the same way as images.
...
#### [](#extension-old_dashes)Extension: `old_dashes` ±
...
#### [](#extension-angle_brackets_escapable)Extension: `angle_brackets_escapable` ±
...
#### [](#extension-lists_without_preceding_blankline)Extension: `lists_without_preceding_blankline` ±

Allow a list to occur right after a paragraph, with no intervening blank space.

#### [](#extension-four_space_rule)Extension: `four_space_rule` ±
...
#### [](#extension-ignore_line_breaks)Extension: `ignore_line_breaks` ±
...
#### [](#extension-east_asian_line_breaks)Extension: `east_asian_line_breaks` ±
...
#### [](#extension-tex_math_gfm)Extension: `tex_math_gfm` ±
...
#### [](#extension-markdown_attribute)Extension: `markdown_attribute` ±
...
#### [](#extension-mmd_title_block)Extension: `mmd_title_block` ±
...
#### [](#extension-abbreviations)Extension: `abbreviations` ±
...
#### [](#extension-autolink_bare_uris)Extension: `autolink_bare_uris` ±
...
#### [](#extension-compact_definition_lists)Extension: `compact_definition_lists` ±
...
#### [](#extension-gutenberg)Extension: `gutenberg` ±
...
#### [](#extension-sourcepos)Extension: `sourcepos` ±
...
#### [](#extension-short_subsuperscripts)Extension: `short_subsuperscripts` ±
...
#### [](#extension-wikilinks_title_after_pipe)Extension: `wikilinks_title_after_pipe` ±
...
[](#specifying-bibliographic-data)Specifying bibliographic data
---------------------------------------------------------------
...
### [](#conference-papers-published-vs.-unpublished)Conference Papers, Published vs. Unpublished
...
[](#specifying-a-citation-style)Specifying a citation style
-----------------------------------------------------------
...
[](#citations-in-note-styles)Citations in note styles
-----------------------------------------------------
...
[](#placement-of-the-bibliography)Placement of the bibliography
---------------------------------------------------------------
...
### [](#additional-columns-attributes-in-beamer)Additional columns attributes in beamer
...
[](#background-in-reveal.js-beamer-and-pptx)Background in reveal.js, beamer, and pptx
-------------------------------------------------------------------------------------

Background images can be added to self-contained reveal.js slide shows, beamer slide shows, and pptx slide shows.

### [](#on-all-slides-beamer-reveal.js-pptx)On all slides (beamer, reveal.js, pptx)
...
#### [](#parallaxbackgroundimage-reveal.js)`parallaxBackgroundImage` (reveal.js)
...
### [](#on-individual-slides-reveal.js-pptx)On individual slides (reveal.js, pptx)
...
### [](#on-the-title-slide-reveal.js-pptx)On the title slide (reveal.js, pptx)
...
### [](#example-reveal.js)Example (reveal.js)
...
[](#the-epubtype-attribute)The `epub:type` attribute
----------------------------------------------------
...
If the input format already is HTML then `data-external="1"` will work as expected for `<img>` elements. Similarly, for Markdown, external images can be declared with `!img{external=1}`. Note that this only works for images; the other media elements have no native representation in pandoc’s AST and require the use of raw HTML.
...
[](#accessible-pdfs-and-pdf-archiving-standards)Accessible PDFs and PDF archiving standards
===========================================================================================
...
[](#running-pandoc-as-a-web-server)Running pandoc as a web server
=================================================================
...
[](#running-pandoc-as-a-lua-interpreter)Running pandoc as a Lua interpreter
===========================================================================

Calling the pandoc executable under the name `pandoc-lua` or with `lua` as the first argument will make it function as a standalone Lua interpreter. The behavior is mostly identical to that of the standalone `lua` executable, version 5.4. However, there is no REPL yet, and the `-i` option has no effect. For full documentation, see the pandoc-lua man page.
...
Copyright 2006–2022 John MacFarlane (\[email protected\]). Released under the GPL, version 2 or greater. This software carries no warranty of any kind. (See COPYRIGHT for full copyright and warranty notices.) For a full list of contributors, see the file AUTHORS.md in the pandoc source code.
